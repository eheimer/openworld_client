...
namespace Openworld
{
  public class Communicator : MonoBehaviour
  {
    ...
    //   by GenerateCommunicator.
    public void CreateCharacter(string gameId, string name, int raceId, Action<CharacterDetail> success, Action<RequestException> error)
    {
      var path = "/games/{gameId}/characters";
      path = path.Replace("{gameId}", gameId);
      var req = getAuthorizedRequest(path);
      req.Body = new CreateCharacterRequest { name = name, raceId = raceId };
