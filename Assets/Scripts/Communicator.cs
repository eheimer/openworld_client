...
namespace Openworld
{
  public class Communicator : MonoBehaviour
  {
    ...
    // Autogenerated 3/22/2022 10:21:41 AM
    //   by GenerateCommunicator.
    public void CreateGame(string name, Action<ResponseHelper> success, Action<RequestException> error)
    {
      var path = "/games";
      var req = getAuthorizedRequest(path);
    ...
    //   by GenerateCommunicator.
    public void CreateCharacter(string gameId, string name, Action<ResponseHelper> success, Action<RequestException> error)
    {
