...
namespace Openworld
{
  public class Communicator : MonoBehaviour
  {
    ...
    //   by GenerateCommunicator.
    public void CreateCharacter(string gameId, string name, int raceId, int strength, int dexterity, int intelligence, Action<CharacterDetail> success, Action<RequestException> error)
    {
