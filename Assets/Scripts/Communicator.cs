...
namespace Openworld
{
  public class Communicator : MonoBehaviour
  {
    ...
    //   by GenerateCommunicator.
    public virtual void CreateCharacter(string gameId, string name, int raceId, int strength, int dexterity, int intelligence, CharacterSkill[] skills, Action<CharacterDetail> success, Action<RequestException> error)
    {
      var path = "/games/{gameId}/characters";
      path = path.Replace("{gameId}", gameId);
      var req = getAuthorizedRequest(path);
      req.Body = new CreateCharacterRequest { name = name, raceId = raceId, strength = strength, dexterity = dexterity, intelligence = intelligence, skills = skills };
